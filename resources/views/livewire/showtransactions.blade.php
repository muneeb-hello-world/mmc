...
new class extends Component {
    ...
    {
        $this->start = Carbon::parse($this->date . ' ' . $this->startTime)->startOfMinute();
        $this->end = Carbon::parse($this->date . ' ' . $this->endTime)->startOfMinute();
    ...
    public function loadTransactions()
    {
        ...
        $this->transactions = ServiceTransaction::with(['patient', 'doctor', 'service'])
            ...
            ->get();
        $this->labs = LabTestTransaction::with(['patient', 'doctor', 'labTest'])
            ->whereBetween('created_at', [$this->start, $this->end])
            ->orderBy('created_at', 'desc')
            ->get();
        // dd($this->labs);
        ...
        // "amount" => "500.00"
        // "doctor_share" => "205.00"
        // "hospital_share" => "205.00"
        // "doctor_payout_id" => null
        // "created_at" => "2025-08-07 17:05:23"
        // "updated_at" => "2025-08-07 17:05:23"
        // "is_returned" => 0
    }
};
?>
